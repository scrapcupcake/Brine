require.config({
    baseUrl: "https://rawgithub.com/scrapcupcake/Brine/master/lib/brine/prompt/",
    paths: {
...
require(["Handlebars","hbars!brine","text!brine.css"],function(Handlebars,rawTemplate,brineCss){
